...
class ConvBNLayer(nn.Layer):
    ...
    def convert_to_deploy1(self):
        ...
        self.__delattr__('_conv')
        self.__delattr__('_batch_norm')
    def get_equivalent_kernel_bias(self):
        kernel = self._conv.weight
        running_mean = self._batch_norm._mean
        running_var = self._batch_norm._variance
        gamma = self._batch_norm.weight
        beta = self._batch_norm.bias
        eps = self._batch_norm._epsilon
