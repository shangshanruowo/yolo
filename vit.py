...
class MobileViTV3BlockV2(nn.Layer):
    ...
    def unfolding(self, feature_map):
        ...
        # print("patch_h",self.patch_h)
        # print("patch_w", self.patch_w)
        # print("patches.shape",patches.shape)
        patches = patches.reshape(
            [batch_size, in_channels, self.patch_h * self.patch_w, -1])
        # print("last",patches.shape)
        # print('..........................')
...
class MobileViTV3(nn.Layer):
    ...
    def __init__(self,
        ...
        # self._out_channels = [128, 192, 256]
        self._out_channels = [64, 80, 128]
...
def MobileViTV3_XXS_L2(pretrained=False, use_ssld=False, **kwargs):
    ...
    mobilevit_config = {
        ...
        "layer3": {  # 28x28
            ...
            "patch_w": 2,
            "stride": 2,
            "mv_expand_tqratio": mv2_exp_mult,
            "head_dim": None,
            "num_heads": 4,
            "block_type": "mobilevit"
        },
...
if __name__ == "__main__":
    net = MobileViTV3_x0_5()
    paddle.summary(net, (1, 3, 640, 640))