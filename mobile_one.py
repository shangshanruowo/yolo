...
class MobileOneNet(nn.Layer):
    ...
    def __init__(self,
        ...
        self._out_channels = [128, 256, 1024]
...
if __name__ == "__main__":
    ...
    paddle.summary(new_net, (1, 3, 640, 640))
